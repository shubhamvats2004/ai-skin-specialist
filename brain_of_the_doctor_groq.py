...
# 1. Provide some fake patient text and an image to test with
# (I see you have a 'sample-image.png' in your folder from your screenshots!)
test_text = "Hi doctor, I have this red itchy spot on my arm. What do you think?"
test_image = "sample-image.png" 

# 2. Send the text and image to your AI doctor function
print("Thinking...")
doctor_response = brain_of_the_doctor(test_text, image_filepath=test_image)

# 3. Print the doctor's final response to the terminal
print(f"Doctor AI says: {doctor_response}")
